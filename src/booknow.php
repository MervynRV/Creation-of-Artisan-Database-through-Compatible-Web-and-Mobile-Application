      ...
      <section aria-label="Newest Photos" style="margin-bottom: 1rem;">
        <div class="carousel" data-carousel>
          ...
          <div class="container" style="margin-bottom: 2rem;">
            ...
            <h3 class="lead" id="facilities">
              TVs, sound systems, refrigerators, mini-bars, free Wi-Fi, coffee-makers, hairdryers, and more.
            </h2>
            <br>
            
            <h4 class="lead" id="liked">
            <b>Liked: Cleanliness, staff & service, amenities, property conditions & facilities.</b>
            </h4>
            <h4 class="lead" id="rating">
              <b>Rating:10/10</b>
            </h4>

          </div>
      
      <div class="text-2" style="color: #758954; font-size: 2.7rem;margin:0 2rem 2rem 2rem;font-weight: 300;">Confirm Check-in and Check-out dates!</div>
        <form id="date-form" style="text-align: center;" method="" action="#">
            <div class="container">
                <div class="row">
                    <div class="wrapper" style="width: 50%;min-width: 150px;">
                        <label for="datepicker" class="datelabel" ><p>Check-in</p>
                ...
                <div class="row">
                    <div class="wrapper" style="width: 50%; min-width: 150px;">
                        <label for="datepicker2" class="datelabel"><p>Check-out</p>
                            <input placeholder="DD-MM-YYYY" required type="text" id="datepicker2"autocomplete="off">
                        </label>	
                    </div>
                </div>
                <div class="row">
                    <div class="wrapper" id="required-label" style="max-width: 30%;min-width: 150px;">
                        <label for="numberofpeople" class="datelabel"><p>Occupants</p>
                ...
                <div class="form-check">
                  <label class="form-check-label" for="flexCheckChecked" style="border: none;color:#3ebf30">
                    <input class="form-check-input" type="checkbox" value="" id="flexCheckChecked" style="margin-right: 15px;" required>
                    I agree to the terms and conditions as set out by the user agreement.
                  </label>
                </div>

                <div class="row">
                    <div class="col-md-12 col-lg-12" style="margin-bottom: 3rem;">
