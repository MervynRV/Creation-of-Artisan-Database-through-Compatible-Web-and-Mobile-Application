   ...
   <div class="nav__list-item">
    ...
    <div class="container">
        ...
        <div class="carousel" data-carousel>
            ...
            <ul data-slides>
                <li class="slide" data-active>
                    <img src="images/c1.png" alt="Hotel 1">
                </li>
                <li class="slide">
                    <img src="images/2.jpg" alt="Hotel 2">
                </li>
                <li class="slide">
                    <img src="images/3.jpg" alt="Hotel 3">
                </li>
                <li class="slide">
                    <img src="images/4.jpg" alt="Hotel 4">
                </li>
                <li class="slide">
                    <img src="images/5.jpg" alt="Hotel 5">
                </li>
            </ul>
        </div>
      </section>
      <div class="container" style="margin-bottom: 2rem;">
        ...
        <h2 class="lead" id="desc" style="font-size: 2rem;"><b>Hotel(Radisson)</b>
        </h2>
      </div>
      ...
      <div class="text-2" style="color: #758954; font-size: 2.7rem;margin-bottom: 2rem;font-weight: 300;">Confirm Check-in and Check-out dates!</div>
        <form id="date-form" style="text-align: center;" method="POST" action="radissondb.php">
            <div class="container">
                <div class="row">
                    <div class="wrapper" style="width: 50%;">
                        <label class="datelabel" style="width: 50%;" ><p style="color: #758954;padding-left: 0.7rem;">Check-in</p>
                            <input name="checkin" placeholder="YYYY-MM-DD"  type="date"  autocomplete="off">
                        </label>	
                    </div>
                </div>
                <div class="row">
                    <div class="wrapper" style="width: 50%;">
                        <label  class="datelabel" style="width: 50%;"><p style="color: #758954;padding-left: 0.7rem;">Check-out</p>
                            <input name="checkout" placeholder="YYYY-MM-DD" type="date"  autocomplete="off">
                        </label>	
                    </div>
                </div>
                <div class="row">
                    <div class="wrapper" style=" width: 30%;">
                        <label for="numberofpeople" class="datelabel" style="width: 60%;"><p style="color: #758954;padding-left: 0.7rem;">Occupants</p>
                            <input name="occupants" placeholder="eg: 4" required type="number" id="numberofpeople">
                        </label>	
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 cold-lg-12" style="margin-bottom: 3rem;">
                        <button  type="submit" name ="done" class="submit_button">Done</button>
                    </div>
                </div>    
            </div>
            </form>
